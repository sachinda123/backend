...
router.get("/list/:offset/:limit", validateRequest("get-all", "customer"), async (req: Request, res: Response) => {
  try {
...
router.post("/create/", validateRequest("post-create", "customer"), async (req: TypedRequestBody, res: Response) => {
  try {
...
router.put("/inactive/:id", validateRequest("put-innactive-id", "customer"), async (req: Request, res: Response) => {
  try {
...
router.delete("/delete/:id", validateRequest("delete-delete-id", "customer"), async (req: Request, res: Response) => {
  try {
    const id = req.params.id;
...
router.put("/update/:id", validateRequest("put-update-id", "customer"), async (req: Request, res: Response) => {
  try {
    const id = req.params.id;
    const { error } = customerSchema.validate(req.body);
    const data = req.body;
