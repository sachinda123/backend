...
const { models: { Medication }, } = require("../models");
const { Op } = require("sequelize");
const { create, getAll, update, deletebyId, checkExist } = require("../functions/modelFunctions");
router.get("/list/:offset/:limit", validateRequest("get-all", "medication"), async (req, res) => {
    try {
...
router.put("/inactive/:id", validateRequest("put-innactive-id", "medication"), async (req, res) => {
    try {
